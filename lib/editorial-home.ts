...
export const editorialHome: Record<Locale, EditorialHome> = {
  en: {
    ...
    heroLine: "Websites, content, systems and follow-up—planned and improved by one accountable team instead of a rotating list of freelancers and vendors.",
    ...
    programs: [
      {
        ...
        proofHint: "A live hospitality launch with a public site and an honest record of what MACS built.",
      },
      {
        name: "Momentum",
        ...
        proofHint: "A live product page with working product evidence and its remaining proof gaps labeled.",
      },
      {
        name: "Scale",
        ...
        proofHint: "Two working products with live project links, build context and clearly labeled evidence gaps.",
      },
      {
        name: "Launch",
        ...
        proofLabel: "ASC3ND",
        proofHint: "A live nonprofit site connected to a documented operations layer.",
      },
    ],
    ...
    clientZeroTitle: "MACS / Built Here",
    ...
    builtItems: [
      { name: "Agent MAXX", line: "Our in-house operator for day-to-day work inside MACS Digital Media, designed for everyday, nontechnical use and built on open-source software.", href: "/maxx" },
      { name: "Buffer Blaster", line: "A content-operations engine for research, production, scoring and scheduling that we can understand, control and improve ourselves.", href: "/work/buffer-blaster" },
  ...
  "es-MX": {
    ...
    heroLine: "Sitio web, contenido, sistemas y seguimiento: planeados y mejorados por un solo equipo responsable, en lugar de una lista cambiante de freelancers y proveedores.",
    ...
    programs: [
      {
        ...
        href: "/programs#reset",
        proofLabel: "Taste of Nawlins",
        proofHint: "Un lanzamiento de hospitalidad con sitio público y un registro claro de lo que construyó MACS.",
      },
      {
        name: "Momentum",
        ...
        href: "/programs#momentum",
        proofLabel: "Buffer Blaster",
        proofHint: "Una página de producto en vivo con evidencia del sistema y faltantes claramente identificados.",
      },
      {
        name: "Scale",
        ...
        href: "/programs#scale",
        proofLabel: "Pare’ + Posta Studio",
        proofHint: "Dos productos funcionales con enlaces en vivo, contexto de desarrollo y faltantes claramente identificados.",
      },
      {
        name: "Launch",
        ...
        href: "/programs#launch",
        proofLabel: "ASC3ND",
        proofHint: "Un sitio público para una organización sin fines de lucro, conectado a una capa operativa documentada.",
      },
    ],
    ...
    clientZeroTitle: "MACS / Hecho aquí",
    ...
    builtItems: [
      { name: "Agent MAXX", line: "Una capa de control para contexto, aprobaciones, avance y evidencia que el dueño puede revisar.", href: "/maxx" },
      { name: "Buffer Blaster", line: "Un motor de operaciones de contenido para investigar, producir, evaluar y programar.", href: "/work/buffer-blaster" },
